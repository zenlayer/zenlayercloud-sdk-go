...
// InquiryPriceCreateLoadBalancerResponseParams 
...
type ListenerBackendHealth struct {
    ...
    // HealthStatusDetail 后端服务健康检查对应端口的健康检查状态。
