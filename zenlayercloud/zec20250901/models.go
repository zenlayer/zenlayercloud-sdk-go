...
type InquiryPriceCreateInstanceResponseParams struct {
    ...
    DataDiskPrices []*PriceItem `json:"dataDiskPrices,omitempty"`
...
type Image struct {
    ...
    MinDiskSize *int `json:"minDiskSize,omitempty"`
...
type DescribeCustomImagesResponse struct {
    *common.BaseResponse
    ...
    Response *DescribeCustomImagesResponseParams `json:"response,omitempty"`
...
type DescribeCustomImagesResponseParams struct {
    ...
    // DataSet 镜像列表数据。
    DataSet []*CustomImage `json:"dataSet,omitempty"`
...
type DescribeImageCopyProgressRequest struct {
    *common.BaseRequest
...
type DescribeImageCopyProgressResponse struct {
    *common.BaseResponse

    RequestId *string `json:"requestId,omitempty"`

    Response *DescribeImageCopyProgressResponseParams `json:"response,omitempty"`

}

type DescribeImageCopyProgressResponseParams struct {

    RequestId *string `json:"requestId,omitempty"`

    // DataSet 镜像复制进度列表，仅包含进行中的目标区域。
    // 镜像状态非SYNCING时返回空列表。
    DataSet []*ImageCopyProgress `json:"dataSet,omitempty"`
...
type ImageCopyProgress struct {
    ...
    DestRegionId *string `json:"destRegionId,omitempty"`

    // DestRegionName 目标区域名称。
    DestRegionName *string `json:"destRegionName,omitempty"`

    // SyncStage 复制阶段。
    SyncStage *string `json:"syncStage,omitempty"`
...
type ModifyIpv6TrafficPackageRequest struct {
    *common.BaseRequest
...
type ModifyIpv6TrafficPackageResponse struct {
    *common.BaseResponse
...
type AsnObservationDetail struct {
    ...
    // ObservedPrefix 观测网段。
    ObservedPrefix *string `json:"observedPrefix,omitempty"`
...
type DescribeEipNetworkLineTypesRequest struct {
    *common.BaseRequest
...
type DescribeEipNetworkLineTypesResponse struct {
    *common.BaseResponse

    RequestId *string `json:"requestId,omitempty"`

    Response *DescribeEipNetworkLineTypesResponseParams `json:"response,omitempty"`

}

// DescribeEipNetworkLineTypesResponseParams 
type DescribeEipNetworkLineTypesResponseParams struct {

    RequestId *string `json:"requestId,omitempty"`

    // RegionNetworkLineTypes 各节点支持的IP线路类型列表。
    RegionNetworkLineTypes []*EipRegionNetworkLineType `json:"regionNetworkLineTypes,omitempty"`

}

// EipRegionNetworkLineType 节点与其支持的IP线路类型映射。
type EipRegionNetworkLineType struct {

    // RegionId 节点ID。
    RegionId *string `json:"regionId,omitempty"`

    // NetworkLineTypes 该节点支持的IP线路类型列表。
    NetworkLineTypes []string `json:"networkLineTypes,omitempty"`
...
type DescribeQosPolicyGroupsRequest struct {
    *common.BaseRequest
    ...
    // 最多支持100个ID查询。
    QosPolicyGroupIds []string `json:"qosPolicyGroupIds,omitempty"`
...
type DescribeQosPolicyGroupsResponse struct {
    *common.BaseResponse

    RequestId *string `json:"requestId,omitempty"`

    Response *DescribeQosPolicyGroupsResponseParams `json:"response,omitempty"`

}

type DescribeQosPolicyGroupsResponseParams struct {
    ...
    // DataSet QoS策略组结果集。
    DataSet []*QosPolicyGroup `json:"dataSet,omitempty"`
