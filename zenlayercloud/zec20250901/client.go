...
// DescribeDiskRegions 查询支持售卖云硬盘的节点信息。
...
// DescribeDiskCategory 查询可用区支持的云盘类型。
...
// DescribeCidrPrice 查询 IPv4 CIDR 地址块售卖价格。
...
// DescribeEipInternetChargeTypes 查询 EIP 支持的网络计费模式。
...
// ModifyEipAttribute 修改弹性公网IP属性。目前该接口支持修改名称。
